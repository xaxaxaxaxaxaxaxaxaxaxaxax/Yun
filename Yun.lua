...
function initLibrary()
    ...
    function utility.drag(obj, dragSpeed)
        ...
        inputService.InputChanged:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseMovement or Enum.UserInputType.Touch and dragging then   
            ...
            function tabTypes:Section(opts)
                ...
                function sectionTypes:Keybind(opts)
                    ...
                    local keys = {
                        ...
                        [Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch] = "Mouse 1";
